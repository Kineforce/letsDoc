...
class MapSistemas_controller extends Helpers
{
    ...
    function retornaDadosMapSistemas()
    {
        ...
        $data_array['dados'] = $this->outputFormatado($this->model_functions->retornaInfoMapSistemasFiltro($palavraBuscada, $limit));
    ...
    function retornaExcelMapSistemas()
    {
        ...
        $td_header_web = array('NOME', 'DESCRICAO', 'ANEXO', 'DATABASE', 'SERVIDOR', 'SETOR', 'OCORRENCIA', 'ATIVO', 'DATA_INSERT');

        $result_excel = $this->retornaExcelExportacaoGeral('ms', 'Relatório de Sistemas e Processos - IESB', $td_header_web, $data_servidores_web);
